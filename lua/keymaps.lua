...
local mappings = {
	...
	j = {
		...
		c = {":TSTextobjectGotoNextStart @conditional.outer<CR>", "[C]onditional"},
		b = {":TSTextobjectGotoNextStart @block.outer<CR>", "[B]lock"},
		l = {":TSTextobjectGotoNextStart @loop.outer<CR>", "[L]oop"},
		p = {":TSTextobjectGotoNextStart @parameter.outer<CR>", "[P]arameter"},
		i = {
			name = "[I]nner",
			f = {":TSTextobjectGotoNextStart @function.inner<CR>", "[F]unction"},
			c = {":TSTextobjectGotoNextStart @conditional.inner<CR>", "[C]onditional"},
			b = {":TSTextobjectGotoNextStart @block.inner<CR>", "[B]lock"},
			l = {":TSTextobjectGotoNextStart @loop.inner<CR>", "[L]oop"},
			p = {":TSTextobjectGotoNextStart @parameter.inner<CR>", "[P]arameter"},
		},
		e = {
			name = "[E]nd of:",
			f = {":TSTextobjectGotoNextEnd @function.outer<CR>", "[F]unction"},
			c = {":TSTextobjectGotoNextEnd @conditional.outer<CR>", "[C]onditional"},
			b = {":TSTextobjectGotoNextEnd @block.outer<CR>", "[B]lock"},
			l = {":TSTextobjectGotoNextEnd @loop.outer<CR>", "[L]oop"},
			p = {":TSTextobjectGotoNextEnd @parameter.outer<CR>", "[P]arameter"},
			i = {
				name = "[I]nner",
				f = {":TSTextobjectGotoNextEnd @function.inner<CR>", "[F]unction"},
				c = {":TSTextobjectGotoNextEnd @conditional.inner<CR>", "[C]onditional"},
				b = {":TSTextobjectGotoNextEnd @block.inner<CR>", "[B]lock"},
				l = {":TSTextobjectGotoNextEnd @loop.inner<CR>", "[L]oop"},
				p = {":TSTextobjectGotoNextEnd @parameter.inner<CR>", "[P]arameter"},
			}
		},
	},
	J = {
		name = "[J]ump to Previous:",
		f = {":TSTextobjectGotoPreviousStart @function.outer<CR>", "[F]unction"},
		c = {":TSTextobjectGotoPreviousStart @conditional.outer<CR>", "[C]onditional"},
		b = {":TSTextobjectGotoPreviousStart @block.outer<CR>", "[B]lock"},
		l = {":TSTextobjectGotoPreviousStart @loop.outer<CR>", "[L]oop"},
		p = {":TSTextobjectGotoPreviousStart @parameter.outer<CR>", "[P]arameter"},
		i = {
			name = "[I]nner",
			f = {":TSTextobjectGotoPreviousStart @function.inner<CR>", "[F]unction"},
			c = {":TSTextobjectGotoPreviousStart @conditional.inner<CR>", "[C]onditional"},
			b = {":TSTextobjectGotoPreviousStart @block.inner<CR>", "[B]lock"},
			l = {":TSTextobjectGotoPreviousStart @loop.inner<CR>", "[L]oop"},
			p = {":TSTextobjectGotoPreviousStart @parameter.inner<CR>", "[P]arameter"},
		},
		e = {
			name = "[E]nd of:",
			f = {":TSTextobjectGotoPreviousEnd @function.outer<CR>", "[F]unction"},
			c = {":TSTextobjectGotoPreviousEnd @conditional.outer<CR>", "[C]onditional"},
			b = {":TSTextobjectGotoPreviousEnd @block.outer<CR>", "[B]lock"},
			l = {":TSTextobjectGotoPreviousEnd @loop.outer<CR>", "[L]oop"},
			p = {":TSTextobjectGotoPreviousEnd @parameter.outer<CR>", "[P]arameter"},
			i = {
				name = "[I]nner",
				f = {":TSTextobjectGotoPreviousEnd @function.inner<CR>", "[F]unction"},
				c = {":TSTextobjectGotoPreviousEnd @conditional.inner<CR>", "[C]onditional"},
				b = {":TSTextobjectGotoPreviousEnd @block.inner<CR>", "[B]lock"},
				l = {":TSTextobjectGotoPreviousEnd @loop.inner<CR>", "[L]oop"},
				p = {":TSTextobjectGotoPreviousEnd @parameter.inner<CR>", "[P]arameter"},
			}
		},
	},
	f = {
